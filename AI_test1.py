...
f_card = open("AI_test_card1.txt",'w')
...
def bidTest1(north, west, south, east):
    f_bid1 = open('AI_test_bid1.txt','w')
    f_bid1.writelines('North: \n')
    f_bid1.writelines('BigPoints is ' + str(north.ai.BIGCardPoints)+'\n')
    f_bid1.writelines('WinPiers is ' + str(north.ai.WinPiers)+ '\n')
    f_bid1.writelines('Number of Club is ' + str(north.ai.DiffColorCardNumber[0]) + '\n')
    f_bid1.writelines('Number of Diamond is ' + str(north.ai.DiffColorCardNumber[1]) + '\n')
    f_bid1.writelines('Number of Heart is ' + str(north.ai.DiffColorCardNumber[2]) + '\n')
    f_bid1.writelines('Number of Spade is ' + str(north.ai.DiffColorCardNumber[3]) + '\n')
    f_bid1.writelines('BigPoints of Club is ' + str(north.ai.DiffColorBIGCardPoints[0]) + '\n')
    f_bid1.writelines('BigPoints of Diamond is ' + str(north.ai.DiffColorBIGCardPoints[1]) + '\n')
    f_bid1.writelines('BigPoints of Heart is ' + str(north.ai.DiffColorBIGCardPoints[2]) + '\n')
    f_bid1.writelines('BigPoints of Spade is ' + str(north.ai.DiffColorBIGCardPoints[3]) + '\n')

    f_bid1.writelines('Bidding logs \n')
    f_bid1.writelines('     north        west        south       east \n')
    Round = 0
    ifEnd = False
    passTimes = 0
    BidColor = 0
    ...
    while ifEnd == False :
        ...
        for p in range(4):
            ...
            if passTimes == 3 and BidNumber > 0:
                ifEnd = True
                break
            elif passTimes == 4:
                ifEnd = True
    ...
    poStr = getPosStr(po)
    f_bid1.write('Result of bidding: ' + poStr + ' ' + numStr + coStr)
    f_bid1.close()
...
if __name__ == '__main__':
    ...
    east = AIPlayer(Position.East.value, 1)
    north = AIPlayer(Position.North.value, 1)
    west = AIPlayer(Position.West.value, 1)
    ...
    #bidding test
    bankerPos, BidNumber, Trump = bidTest1(north, west, south, east)
